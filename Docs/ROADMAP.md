...
- [x] Collision + physics — [Jolt Physics](https://github.com/jrouwe/JoltPhysics); full rigid body (Static/Dynamic/Kinematic), all shapes, triggers, callbacks — see [`physics-design.md`](physics-design.md)
